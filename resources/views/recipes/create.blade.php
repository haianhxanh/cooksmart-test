<head>
    <title>Cook Smart - Create recipe</title>
  </head>
    ...
    <div class="form-create">
        ...
        <form method="post" class="form-group" action="{{action('RecipeController@store')}}">
            ...
            <div class="form__container">
                <div class="form__container__top-section">
                    <div class="form__container__top">
                    ...
                    <div class="form__container__top-section__img">
                        <img src="{{ asset('/img/create-logo.png') }}" alt="">
                    </div>
                </div>
